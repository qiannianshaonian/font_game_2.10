...
(0,_cliSharedUtils.info)(`${_constanst.LOG_TITLE}开始编译原整包...`),c?n.watch({aggregateTimeout:1e3,ignored:/node_modules/},o):n.run(o)};// 给 minigame-jsframework 使用
exports.build=build;const zip=({name:a,pathFrom:b,pathTo:c,signFile:d})=>{const e=(0,_readdir.default)(b);return(0,_rpk.default)(a,e,b,c,d)};exports.zip=zip;